...
void FIRE_TASK(void const *argument)
{
	...
	while (1)
	{
        ...
        Deal_Fire_Set_Rpm();//�ı�Ħ����ת��
        Send_Fire_Set_Rpm();//���͵���Ħ�����趨ת��
        Send_Fire_Motor_Speed(left_speed_up, right_speed_up, left_speed, right_speed);//���͵���Ħ����ʵ��ת��
				//Send_Fire_Motor_Speed(4800, 4800, 4800, 4800);//���͵���Ħ����ʵ��ת��
