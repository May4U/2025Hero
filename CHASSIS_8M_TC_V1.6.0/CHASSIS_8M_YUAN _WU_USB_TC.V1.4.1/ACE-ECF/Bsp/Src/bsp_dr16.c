...
void Dr16RxCallBack_Init(void (*callbackFunction)(void))
{
    Dr16RxCallBack = callbackFunction;
}
/************************** Dongguan-University of Technology*-ACE**************************
...
void ECF_RC_UART_Handler(void){
    uint8_t dr16_Recive_flag = 1;
    RC_UART_IRQHandler(&CONFIG_DR16_USART_HANDLE);
    if (Dr16RxCallBack != NULL) Dr16RxCallBack();
}
